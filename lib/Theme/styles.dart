...
class AppThemes {
  ...
  static TextStyle text18container = TextStyle(
    fontWeight: FontWeight.bold,
      fontSize: 18, color: Color(0xffffffff),fontFamily:'Roboto_Medium');
  static TextStyle text18containerblack = TextStyle(
      fontWeight: FontWeight.bold,
      fontSize: 18, color:  Color(0xffd3d3d3),fontFamily:'Roboto_Medium');
  static TextStyle text30container = TextStyle(
      fontSize: 30, color: Color(0xffffffff),fontFamily:'Roboto_Bold');
  static TextStyle text25container = TextStyle(
      fontSize: 25, color: Color(0xffffffff),fontFamily:'Roboto_Bold');
