...
import 'file:///E:/flutter2/ticketapp/lib/screen/Notify/notify.dart';
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                            "${giatien * controllerDetail.listChairSelected.length} đ",
                            style: AppThemes.Text18Medium),
                      ],
                    ),
                  ],
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(  "${giatien * controllerDetail.listChairSelected.length*0.5} đ"),
                      ),
                    )
                  ],
                ),
              ...
              Padding(
                ...
                child: RaisedButton(
                  onPressed: () {
                    ...
                    controllerDetail.listChairSelected=[];
                    print(controllerDetail.listTicketed[0].listcho);
