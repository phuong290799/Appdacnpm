                    ...
                    Positioned(
                        ...
                        child: Opacity(opacity: 0.2,
                            child:Container(
                              ...
                              height: 180,
                              width: 190,
                              child:  Image(image: AssetImage("assets/images/bus.png")),
                            ))),
                    Padding(
                      ...
                      right: 40,
                        ...
                        child:InkWell(child: Container(
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [BoxShadow(blurRadius: 1, color: Color(0xffc4c4c4), spreadRadius: 1)],
                          ),
                          child: CircleAvatar(
                            backgroundColor: Color(0xfff2f2f2),
                            child: Icon(Icons.wifi_protected_setup,color: Color(0xff6d6d6d),),
                          ),
                        ),
                        onTap: (){
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              InkWell(
                                ...
                                onTap: () {
                                  homeController.listHistory.removeRange(0, homeController.listHistory.length);
                        ...
                        child: Container(
                          //decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(40)),color: Colors.deepPurpleAccent),
                            ...
                            child: Card(
                              ...
                              child: InkWell(
                                onTap: () {
                                  homeController.noidi.text=homeController.listHistory[index].noiDi;
                                  homeController.noiden.text=homeController.listHistory[index].noiDen;
                                  homeController.day.value=homeController.listHistory[index].ngayDi;
